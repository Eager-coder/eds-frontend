			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div>
							<p className="text-muted-foreground text-sm font-medium">{t('id')}</p>
							<p>{user.id}</p>
						</div>
						<div>
						...
						<div>
							<p className="text-muted-foreground text-sm font-medium">{t('department')}</p>
							<p>{user.department}</p>
						</div>
						<div>
							<p className="text-muted-foreground text-sm font-medium">{t('position')}</p>
							<p>{user.position}</p>
						</div>
						<div>
							<p className="text-muted-foreground text-sm font-medium">{t('reg.date')}</p>
							<p>{user.regDate}</p>
						</div>
						<div>
