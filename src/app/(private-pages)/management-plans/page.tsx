...
import { useUserManagementPlans } from '@/api-client/user/management-plan/getUserManagementPlans';
...
export default function Page() {
	...
	const {
		...
		isError,
		error
	} = useUserManagementPlans({ enabled: !!user, queryKey: ['userManagementPlans'] });
