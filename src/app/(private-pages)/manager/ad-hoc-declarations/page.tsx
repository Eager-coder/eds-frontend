...
import { useGetAllAdHocDeclares } from '@/api-client/manager/ad-hoc-declarations/getAllAdHocDeclares';
import { useGetAllAdHocExcludes } from '@/api-client/manager/ad-hoc-declarations/getAllAdHocExcludes';
	...
	return (
		<div className="w-full flex-1 space-y-10 p-6">
			<div className="mb-6 flex items-center justify-between">
				<h1 className="text-2xl font-semibold">Ad-hoc declarations</h1>
				<Link
						...
						<Table>
							...
							<TableBody>
								{adHocDeclares.map((decl) => (
									<TableRow
										key={decl.id}
										onClick={() => router.push(`/manager/ad-hoc-declarations/declare/${decl.id}`)}
								...
								{adHocExcludes.map((excl) => {
									...
									return (
										<TableRow
											key={excl.id}
											onClick={() =>
												router.push(`/manager/ad-hoc-declarations/exclude/${excl.id}`)
											}
											className="cursor-pointer border-b border-zinc-300 last:border-0 hover:bg-zinc-50"
										>
