...
const formSchema = z.object({
  ...
  certify: z.boolean().refine((val) => val === true, {
    message:
      "You must certify that you have read the Policy and Procedure on Conflicts of Interest",
  }),
...
export default function DeclarationPage({ params }: { params: { id: string } }) {
  ...
  const [affiliatedPersons, setAffiliatedPersons] = useState<
    Array<z.infer<typeof affiliatedPersonSchema>>
  >([]);
  const [workEngagements, setWorkEngagements] = useState<
    Array<z.infer<typeof workEngagementSchema>>
  >([]);
  const [studentAffiliates, setStudentAffiliates] = useState<
    Array<z.infer<typeof studentAffiliateSchema>>
  >([]);
  ...
  const addRelative = () => {
    ...
    const relationDegree =
      (document.getElementById("relationDegree") as HTMLInputElement)?.value || "";
  ...
  const addAffiliatedPerson = () => {
    // Get values from input fields
    const fullName =
      (document.getElementById("affiliatedFullName") as HTMLInputElement)?.value || "";
    const relationDegree =
      (document.getElementById("affiliatedRelationDegree") as HTMLInputElement)?.value || "";
    const organization =
      (document.getElementById("affiliatedOrganization") as HTMLInputElement)?.value || "";
    const position =
      (document.getElementById("affiliatedPosition") as HTMLInputElement)?.value || "";
    const department =
      (document.getElementById("affiliatedDepartment") as HTMLInputElement)?.value || "";
  ...
  const addWorkEngagement = () => {
    ...
    const organizationType =
      (document.getElementById("organizationType") as HTMLInputElement)?.value || "";
    const organizationName =
      (document.getElementById("organizationName") as HTMLInputElement)?.value || "";
    const registrationNumber =
      (document.getElementById("registrationNumber") as HTMLInputElement)?.value || "";
  ...
  const addStudentAffiliate = () => {
    ...
    const relationDegree =
      (document.getElementById("studentRelationDegree") as HTMLInputElement)?.value || "";
    const affiliation =
      (document.getElementById("studentAffiliation") as HTMLInputElement)?.value || "";
    const department =
      (document.getElementById("studentDepartment") as HTMLInputElement)?.value || "";
              ...
              <form className="space-y-8">
                      ...
                      <FormItem className="space-y-3">
                        <FormControl>
                          ...
                          >
                            ...
                            <div className="flex items-center space-x-2">
                              <RadioGroupItem value="do-not-confirm" id="do-not-confirm-1" />
                    ...
                    <div className="mt-4 border rounded-md p-4 bg-gray-50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="relationDegree" placeholder="E.g., Spouse, Sibling" />
                        </div>
                        <div className="space-y-2">
                          ...
                          <div className="space-y-3">
                            {relatives.map((relative, index) => (
                              <div key={index} className="p-3 bg-white border rounded-md">
                                <p>
                                  <span className="font-medium">Name:</span> {relative.fullName}
                                </p>
                                <p>
                                ...
                                <p>
                                  <span className="font-medium">Position:</span> {relative.position}
                                </p>
                                <p>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    ...
                    entities that seek to, or already have entered into transactions with Nazarbayev
                      ...
                      <FormItem className="space-y-3">
                        <FormControl>
                          ...
                          >
                            ...
                            <div className="flex items-center space-x-2">
                              <RadioGroupItem value="do-not-confirm" id="do-not-confirm-2" />
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    3. I declare that I have no equity or other financial/non-financial interest in
                    a company or organization that acts as a party in litigation or arbitration
                    against Nazarbayev University and/or its organizations.
                  </p>
                  <FormField
                    control={form.control}
                    name="question3"
                  ...
                  {question4Value === "yes" && (
                    <div className="mt-4 border rounded-md p-4 bg-gray-50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="affiliatedRelationDegree">Relation degree</Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="affiliatedOrganization" placeholder="Enter organization" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="affiliatedDepartment">Department/Office/School</Label>
                          <Input id="affiliatedDepartment" placeholder="Enter department" />
                        </div>
                      </div>
                    ...
                    <div className="mt-4 border rounded-md p-4 bg-gray-50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input id="organizationType" placeholder="Enter organization type" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="registrationNumber">BIN/IIN or registration number</Label>
                    ...
                    <div className="mt-4 border rounded-md p-4 bg-gray-50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="studentRelationDegree" placeholder="E.g., Child, Sibling" />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="studentAffiliation">Affiliation</Label>
                          <Input id="studentAffiliation" placeholder="Enter affiliation" />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="studentDepartment">Department/Office/School</Label>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    ...
                    organization (foreign or domestic) that does business with (contracts, sponsors,
                    funds, provides goods or services to) Nazarbayev University and/or its
                    organizations?
                  </p>
                  <FormField
                    control={form.control}
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    ...
                    could affect your ability to exercise independent judgment in making decisions?
                  </p>
                  <FormField
                    control={form.control}
                    name="question10"
                ...
                <div className="space-y-4 border-t pt-6">
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>
                            I certify that I have read the Policy and Procedure on Conflicts of
                            Interest and that the above information is correct.
                          </FormLabel>
                          <FormMessage />
                        </div>
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>
                            I confirm that I completed and signed this Declaration myself on
                            my.nu.edu.kz portal using a unique login and password assigned.
                          </FormLabel>
                          <FormMessage />
                        </div>
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>
                            I affirm that my answers are true and accurate to the best of my
                            knowledge. I will promptly and properly advise Nazarbayev University of
                            any changes to the information provided in this declaration.
                          </FormLabel>
                          <FormMessage />
                        </div>
                      </FormItem>
                  ...
                  <p className="text-sm text-red-600 mt-4">
                    I further understand that any false statement may result in disciplinary action.
                  </p>
                </div>
