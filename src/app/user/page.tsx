...
import { DeclarationResponse, fetchUserDeclaration } from "@/api/getUserDeclaration";
                ...
                <form className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <p className="text-gray-700">
                      ...
                      entities that seek to, or already have entered into transactions with
                  ...
                  <div className="space-y-4">
                    <p className="text-gray-700">
                      ...
                      in a company or organization that acts as a party in litigation or arbitration
                        ...
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <div className="space-y-1 leading-none">
                            <FormLabel>
                              ...
                              knowledge. I will promptly and properly advise Nazarbayev University
                              of any changes to the information provided in this declaration.
                            </FormLabel>
                            <FormMessage />
                          </div>
                        </FormItem>
